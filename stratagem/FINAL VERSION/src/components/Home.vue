  ...
  <div class="home">
    ...
    <div class="game-options">
      <div class="option-card">
        ...
        <v-btn @click="startNewGame" color="indigo-lighten-1">Start New Game</v-btn>
      </div>
        ...
        <div v-if="savedGames.length > 0" class="saved-games">
          <div v-for="game in savedGames" :key="game.id" class="saved-game-item">
            ...
            <div class="game-actions">
              <v-btn @click="continueGame(game.id)" color="indigo-lighten-1">Continue</v-btn>
              <v-btn @click="deleteGame(game.id)" color="red-lighten-1">Delete</v-btn>
            </div>
          </div>
        </div>
